 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_P1,   KC_P2,   KC_P3,   KC_LSFT,  KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENTER  },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  { RGB_M_R, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
  { _______, BL_INC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS  },
  { _______, BL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
